...
async function handlePossibleConfigurationMessage() {
    ...
    try {
        const configMessageVisible = await helpers_1.page.evaluate(() => {
        ...
        if (configMessageVisible) {
            ...
            await helpers_1.page.waitForFunction(() => {
                return !document.body.textContent.includes("Configuring the product, please wait");
...
function createFirstUser(password) {
    (0, helpers_1.it)("should create first user", async function () {
        ...
        await (0, helpers_1.dumpPage)(logDir, "After_fillpassword");
...
function enterRegistrationHa(code) {
    (0, helpers_1.it)("should allow setting registration HA", async function () {
        ...
        const logDir = "/run/agama/scripts";
        await (0, helpers_1.dumpPage)(logDir, "Before_goToRegistration");
        await sidebar.goToRegistration();
        await (0, helpers_1.dumpPage)(logDir, "After_goToRegistration");
        await extensionRegistration.fillCode(code);
        await (0, helpers_1.dumpPage)(logDir, "After_Fill_HA_regcode");
        ...
        await (0, helpers_1.dumpPage)(logDir, "After_verifyExtensionRegistration");
    });
}
